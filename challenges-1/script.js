...
console.log("Mark's : ", intMarkWeight, dblMarkHeight, dblMarkBMI);

// Calculate BMI index for John
const dblJohnBMI = calculateBMI(intJohnWeight, dblJohnHeight);
console.log("John's : ", intJohnWeight, dblJohnHeight, dblJohnBMI);

// Whos BMI is higher
const boolMarkHigherBMI = dblMarkBMI > dblJohnBMI;
console.log("Mark's BMI is Highter: ", boolMarkHigherBMI);
